...
import { formatDateTime, normalizeList } from '../utils/fleet'
      ...
      <form className="alerts-filters" onSubmit={applyFilters}>
        ...
        <label>
          ...
          <select name="type" value={formFilters.type} onChange={handleFilterChange}>
            ...
            <option value="RAPID_ACCEL">RAPID_ACCEL</option>
            <option value="SHARP_TURN">SHARP_TURN</option>
            <option value="CRASH_DETECTED">CRASH_DETECTED</option>
          </select>
        </label>
        <label>
          Status
