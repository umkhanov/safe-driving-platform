...
| Ekip Üyesi | Sorumluluk Alanı | Kullanılan Teknolojiler |
|------------|------------------|-------------------------|
| Arda Aydın Kılınç | Backend geliştirme: API tasarımı, kimlik doğrulama/yetkilendirme, veritabanı şeması, analiz motoru, gerçek zamanlı alarm yayını | Node.js, Express, SQLite (better-sqlite3), JWT, bcrypt, Socket.io |
| Magomed Umkhanov | Mobil uygulama geliştirme: giriş ekranı, sensör entegrasyonu, telemetri gönderim akışı, sürüş oturumu yönetimi | React Native, Expo, expo-sensors, expo-location |
| Edem Makhsudov | Dashboard geliştirme: sayfa yapısı, analitik grafikler, alarm/araç/sürücü/yolculuk yönetim ekranları, gerçek zamanlı arayüz güncellemeleri | React, Vite, Recharts, Socket.io-client |
